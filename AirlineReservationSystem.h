...
void inorderTraversalSearchFlight(BSTNode<Flight>* r,const std::string &departureCity, const std::string &arrivalCity , std::vector<Flight *> &v);
BSTNode<Flight>* searchFlightCode(BSTNode<Flight>* r, const std::string &flightCode);
