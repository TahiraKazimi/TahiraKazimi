...
void removeFollowersFollowing(Profile *&followingProf, LinkedList<Profile*>& followersList);
void removeFollowingsFollower(Profile* &followersProf, LinkedList<Profile*> & followingList);
